...
/**
 * Let's create a FoodApp Low Level Design
 * 
 *  Header
 * 
    *  - Logo
...
const RestaurantCard = ({
  ...
  return (
    <div className="res-card">
      ...
      <b className="res-time">{deliveryTime} Min</b>
      <span className="res-cusines">{cuisines.join(", ")}</span>
      <p className="costfortwo">₹{costForTwo / 100} FOR TWO</p>
  ...
  return (
    <div className="res-container">
      {restaurantList.map((restaurant) => (
        <RestaurantCard
          key={restaurant.data.id} // Add key for better performance
          {...restaurant.data}
        />
      ))}
    </div>
